...
class Runner {
    ...
    public static void main(String[] args) {
        ...
        print(scalar.add(matrix)); //выведет в консоль 6.0
        print(scalar.sub(vector)); //выведет в консоль 0.0
...
//        /* Уровень сложности B (векторные операции) закомментируйте, если не реализовали */
        print(vector.add(scalar)); //выведет в консоль {2.0, 4.0, 6.0}
        print(vector.sub(matrix)); //выведет в консоль {0.0, 0.0, 0.0}
