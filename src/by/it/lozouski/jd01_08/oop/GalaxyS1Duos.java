...
class GalaxyS1Duos extends SamsungMobile {
    ...
    public GalaxyS1Duos(String modelName, String operationSystem, int releaseYear) {
        super(modelName);
    ...
    public void blueTooth() {
        System.out.println("Model " + super.getModelName() + " supports BlueTooth Version 3");
    }

    @Override
    public void wiFi() {
        System.out.println("Model " + super.getModelName() + " supports Wi-Fi Version 2.1");
    }
